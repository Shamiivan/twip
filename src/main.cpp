...
int main(int argc, char const* argv[]) {
  ...
  int file_desc;
  std::string path = "/home/models/twip_1.3.0_aug.onnx";
  ...
  try {
    ...
    while (1) {
      ...
      input_buffer[0] = imu_data[1];
      input_buffer[0] = prev_motor_cmd[0];
      input_buffer[0] = prev_motor_cmd[1];
      model.run();

      motor_cmd [0] = model.get_output_buffer()[0];
      motor_cmd [1] = model.get_output_buffer()[1];

      prev_motor_cmd[0] = motor_cmd[0];
      prev_motor_cmd[1] = motor_cmd[1];
